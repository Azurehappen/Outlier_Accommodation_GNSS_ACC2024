...
%---------------------------------------%
% EKF parameters
p.ekf_para.q_pos = 20^2; % Only be applied to Pos model.
p.ekf_para.q_vel = 0;
...
p.raps.poshor_cov_spec = 0.72^2; %1.515
p.raps.posver_cov_spec = 2.88^2;%3.1958
p.raps.velhor_cov_spec = 0.72;
p.raps.velver_cov_spec = 2.88;
